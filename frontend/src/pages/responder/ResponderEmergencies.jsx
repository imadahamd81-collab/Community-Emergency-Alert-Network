  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Active emergencies in your vicinity</p>
      </div>

      {activeEmergencies.length === 0 ? (
        <Card>
          <EmptyState title="No emergencies" description="There are no active emergencies nearby. Stand by!" />
        </Card>
      ) : (
          ...
          {activeEmergencies.map((emergency) => (
            <Card key={emergency._id} className="hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button size="sm" variant="outline" onClick={() => navigate(`/responder/emergency/${emergency._id}`)}>
...
export default ResponderEmergencies
