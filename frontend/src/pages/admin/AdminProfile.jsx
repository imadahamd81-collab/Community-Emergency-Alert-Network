...
import { Loader2, Camera, X, Shield } from 'lucide-react'
...
const AdminProfile = () => {
  ...
  const displayImageUrl = previewUrl || (user?.profileImage && !imageError ? getProfileImageUrl(user.profileImage) : null)
      ...
      <Card>
        <div className="flex flex-col items-center mb-6">
          <div className="relative group">
            <div className="w-24 h-24 rounded-full bg-navy-100 flex items-center justify-center text-3xl font-bold overflow-hidden border-4 border-white shadow-lg">
              {displayImageUrl ? (
                <img
                  src={displayImageUrl}
